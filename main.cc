...
int main(int, char**)
{
	...
	std::vector<std::vector<char>> track;
		...
		file.open("basta-sansara_melodiya.mid", std::ios::in | std::ios::binary);
		...
		for (int i = 0; i < MThd_tracks; i++) {
			...
			if (chunk_type == (
					...
					'r'*0x00010000 +
					'k'*0x01000000)) {
				std::cout << "Это дорожка " << i << std::endl;
			} else {
				std::cout << "А это не дорожка :(" << std::endl;
				break;
			}
			int trk_length;
		...
		size_t trk = 0;
				...
				std::cout << " Для демострации будем работать только с дорожкой " << trk << std::endl;
		...
		while (p < track[trk].size()) {
			...
			case 0x90 ... 0x9f:{
				...
				break;
			case 0xa0 ... 0xaf:
				std::cout << " Это метасобытие 3 - тут скорее всего пропуск" << std::endl;
				break;
			case 0xb0 ... 0xbf:
				int num_par, par;
			...
			case 0xf0:{
				...
				p++;
				std::cout << " Это метасобытие 8" << std::endl;
			}
				break;
			case 0xf1:
				std::cout << " Это метасобытие 9" << std::endl;
				break;
			case 0xf2:
				std::cout << " Это метасобытие 10" << std::endl;
				break;
			case 0xf3:
				std::cout << " Это метасобытие 12" << std::endl;
				break;
			case 0xf4:
				std::cout << " Это метасобытие 13" << std::endl;
				break;
			case 0xf5:
				std::cout << " Это метасобытие 14" << std::endl;
				break;
			case 0xf6:
				std::cout << " Это метасобытие 15" << std::endl;
				break;
			case 0xf7:
				std::cout << " Это метасобытие 16" << std::endl;
				break;
			case 0xf8:
				std::cout << " Это метасобытие 17" << std::endl;
				break;
			case 0xf9:
				std::cout << " Это метасобытие 18" << std::endl;
				break;
			case 0xfa:
				std::cout << " Это метасобытие 19" << std::endl;
				break;
			case 0xfb:
				std::cout << " Это метасобытие 20" << std::endl;
				break;
			case 0xfc:
				std::cout << " Это метасобытие 21" << std::endl;
				break;
			case 0xfd:
				std::cout << " Это метасобытие 22" << std::endl;
				break;
			case 0xfe:
				std::cout << " Это метасобытие 23" << std::endl;
				break;
			case 0xff:
			{
				...
				break;
			default:
				std::cout << "Такого события я не знаю!" << std::endl;
				return 1;
			}
		}
